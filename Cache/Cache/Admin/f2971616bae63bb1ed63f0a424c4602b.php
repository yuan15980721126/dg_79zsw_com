...
<?php if(is_array($member_config)): $i = 0; $__LIST__ = $member_config;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo[varname] =='member_getpwdemaitpl' || $vo[varname]=='member_emailchecktpl') : ?>
<tr>
	<th width="140"><?php echo ($vo["info"]); ?>:</th>
	<td><textarea id="<?php echo ($vo[varname]); ?>" name="<?php echo ($vo[varname]); ?>" rows="5" cols="50"><?php echo (stripslashes(htmlspecialchars($vo['value']))); ?></textarea></td>
</tr>
<?php else :?>
<tr>
	<th width="140"><?php echo ($vo["info"]); ?>:</th>
