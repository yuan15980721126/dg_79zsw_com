	...
	<div class="Member Index index">
		<div class="main">
			<div class="container">
				...
				<div id="fabu_right">
					<div class="ftop">发布课程</div>
					<form enctype="multipart/form-data" class="tab-pane active" id="fabu" style="display: block;" method="post" action="<?php echo URL('User-Index/addkc');?>">
						<div class="form-group">
							<label class="col-sm-2 control-label">课程名称：</label>
							<div class="col-sm-7">
								<input name="title" type="text" class="form-control" maxlength="30" value="" required>
							</div>
						...
						<div class="form-group ">
							...
							<div class="col-sm-7">
								<select name="" class="form-control industry2" id='industry' >
                                	<option>请选择</option>
                                	<?php $k=0;foreach($Categorys as $key=>$r):if(1=="" && $r['isfootermenu']==0){ continue; }if( $r['ismenu']==1 && intval(0)==$r["parentid"] ) :++$k; if($r['catname'] !== '在线课程' && $r['catname'] !== '培训专栏') : ?>
                                	<option value="<?php echo ($r["id"]); ?>"><?php echo ($r["catname"]); ?></option>
										<?php endif; endif; endforeach;?>
                                </select>
                                <select name="industry" class="form-control industry2" id='industry2' >
                                	<option value="5">请先选择课程栏目</option>
                                </select>
							</div>
							<div class="col-sm-3"><i class="red">*</i></div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-7">
								<select name="kccity" class="form-control " >
                                	<option>请选择</option>
                                	<?php $k=0;foreach($Categorys as $key=>$r):if(1=="" && $r['isfootermenu']==0){ continue; }if( $r['ismenu']==1 && intval(69)==$r["parentid"] ) :++$k;?><option value="<?php echo ($r["id"]); ?>"><?php echo ($r["catname"]); ?></option><?php endif; endforeach;?>
                                </select>
							</div>
							<div class="col-sm-3"><i class="red">*</i></div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input name="dx" type="text" class="form-control" value="" >
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input name="systme" type="text" class="form-control" value="">
							</div>
							<div class="col-sm-3"></div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input name="pc" type="text" class="form-control" value="" >
							</div>
							<div class="col-sm-3"></div>
						</div>
						<div class="form-group">
						...
						<!--<div class="form-group">
							<label class="col-sm-2 control-label">网上报名：</label>
							<div class="col-sm-7">
								<input name="pc" type="text" class="form-control" value="" >&nbsp;<label class="control-label">元</label>
							</div>
							<div class="col-sm-3"></div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">线下原价：</label>
							<div class="col-sm-7">
								<input name="price" type="text" class="form-control" value="" >&nbsp;<label class="control-label">元</label>
							</div>
							<div class="col-sm-3"></div>
						</div>-->
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input name="guanzhu" type="text" class="form-control" value="">
							</div>
							<div class="col-sm-3"></div>
						</div>
